...
import styles from './popularartistcard.style'

import {checkImageURL} from '../../../../utils' //3 levels up from the current file (../ means move up 1 directory), ./ means current directory

const PopularArtistCard = ({item, selectedJob, handleCardPress}) => {
  return (
    <TouchableOpacity
